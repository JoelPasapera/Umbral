...
export async function render() {
  ...
  if (meta) {
    // La meta vive aquí desde que "Admisión" ocupó su sitio en la barra. Es un
    // dato que se elige una vez y se consulta poco, así que estaba ocupando el
    // hueco más visible de la aplicación para no hacer casi nada.
    //
    // Lo que sí se lleva a la vista es el índice y el enlace al diagnóstico
    // completo: esconder el número tras dos clics lo saca de la cabeza de la
    ...
    nodos.push(
      el('section', { clase: 'perfil__bloque' }, [
        ...
        el('div', { clase: 'perfil__acciones' }, [
          el('a', { clase: 'boton boton--secundario', texto: 'Ver tu diagnóstico', attrs: { href: '#/meta' } }),
