...
export function tarjetaReto(estado) {
  ...
  const cabecera = el('div', { clase: 'reto__cabecera' }, [
    el('div', {}, [
      el('h2', { clase: 'reto__rotulo', texto: 'Reto de hoy' }),
      el('p', {
        clase: 'reto__nota',
  ...
  const cuerpo = estado.hecho
    ...
    : [
        el('a', {
          // Secundario a propósito: la acción principal de la pantalla es la
          // tarea recomendada. Dos botones negros idénticos no dicen cuál
          // importa más, y entonces ninguno importa.
          clase: 'boton boton--secundario boton--ancho',
          texto: 'Empezar el reto de hoy',
