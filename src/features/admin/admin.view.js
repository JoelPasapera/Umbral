  ...
  return el('li', { clase: 'hueco' }, [
    el('div', { clase: 'hueco__principal' }, [
      ...
      el('span', {
        ...
        texto: `${curso.preguntas} preguntas y ${curso.materiales} materiales, para un curso que pesa ${curso.peso}% del examen`,
      }),
    ]),
      ...
      el(
        ...
        cobertura.temasHuerfanos.map((t) =>
          el('li', { clase: 'huerfano' }, [
            el('span', {}, [
              el('strong', { texto: nombreCurso(t.cursoId) }),
              el('span', { clase: 'huerfano__tema', texto: t.temaId }),
            ]),
